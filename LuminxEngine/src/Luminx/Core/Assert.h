...
namespace Luminx
{
	...
	#define LUM_VERIFY(x)            ::Luminx::Assertion::Verify(AssertionCaller::ClientAssertion, x, __FILE__, __LINE__)
	#define LUM_ASSERT(x, err)       ::Luminx::Assertion::Assert(AssertionCaller::ClientAssertion, x, err)
	#define LUM_CORE_VERIFY(x)       ::Luminx::Assertion::Verify(AssertionCaller::CoreAssertion, x, __FILE__, __LINE__)
	#define LUM_CORE_ASSERT(x, err)  ::Luminx::Assertion::Assert(AssertionCaller::CoreAssertion, x, err)
#else
