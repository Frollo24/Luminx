...
#define LUM_BIT(x) (1 << x)

#define LUM_BIND_EVENT_FN(fn) [this](auto&&... args) -> decltype(auto) { return this->fn(std::forward<decltype(args)>(args)...); }

#define LUM_DEFINE_ENUM_FLAG_OPERATORS(enumtype) \
extern "C++" { \
