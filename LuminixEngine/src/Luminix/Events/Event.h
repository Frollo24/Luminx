...
namespace Luminix
{
	...
	enum EventCategory : int
	{
		...
		EVENT_CATEGORY_APPLICATION = LUM_BIT(0),
		EVENT_CATEGORY_WINDOW = LUM_BIT(1),
		EVENT_CATEGORY_INPUT = LUM_BIT(2),
		EVENT_CATEGORY_KEYBOARD = LUM_BIT(3),
		EVENT_CATEGORY_MOUSE = LUM_BIT(4),
		EVENT_CATEGORY_MOUSE_BUTTON = LUM_BIT(5),
	};
